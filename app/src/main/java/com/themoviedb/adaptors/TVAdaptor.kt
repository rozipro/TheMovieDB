...
class TVAdaptor(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TVAdaptor.TVViewHolder {
        return TVAdaptor.TVViewHolder(
    ...
    override fun onBindViewHolder(holder: TVAdaptor.TVViewHolder, position: Int) {
        val tv = tvs[position]
